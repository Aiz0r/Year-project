...
<html>
    ...
    <body> 
        ...
        <div class = linkspart style="height: 50px;">
            ...
            <div class = "Text">
                <p>
                    Добро пожаловать в наш мир оригинальных сладостей!
                </p>
                <p>
                
                Натуральные, красивые и оригинальные сладости ручной работы: зефир, маршмеллоу,  безе, леденцы, птичье молоко, торты и много другое станут прекрасной альтернативой коробке конфет или букету цветов и просто вкусным дополнением к вашему столу. Мы используем только качественные, натуральные и свежие продукты.
                 </p>
            </div>
        </main>
        <footer>
