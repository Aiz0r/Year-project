        ...
        <div class = linkspart style="height: 50px;">
            ...
            <div class = "Text">
                <form method="get" action="#">
                        ...
                        <p class = "Text">
                            <input placeholder ="Ваше имя" type='text' name= 'newOrder'>
                        </p>
                        <p class = "Text">
                            Ваш e-mail:
                        </p>
                        <p class = "Text">
                            <input placeholder ="Ваш адрес эл. почты" type='text' name= 'newOrder'>
                        </p>
                        <p class = "Text">
                            Ваш телефон:
                        </p>
                        <p class = "Text">
                            <input placeholder ="Ваш телефон" type='number' name= 'newOrder'>
                        </p>
                        <p class = "Text">
                        ...
                        <input type ='submit' value = 'Отправить заказ' class = "Text">
